...
Размер выборки: 26,666 строк
Фильтрация: Отброшено 37,334 строк, после чтения файла
...
Тип сканирования: Bitmap Heap/Index Scan
Размер выборки: 2,666 строк
Фильтрация: Отброшено 37,334 строк на уровне индекса, индекс отсекает ненужные строки до обращения к таблице
